...
HUGGINGFACE_MODEL_DIR = os.environ.get("HUGGINGFACE_MODEL_DIR", os.path.join(BASE_DATA_DIR, "models"))


def get_hf_model_config(model_name: str, **kwargs) -> AutoConfig:
    config = AutoConfig.from_pretrained(os.path.join(HUGGINGFACE_MODEL_DIR, model_name), **kwargs)
    return config
