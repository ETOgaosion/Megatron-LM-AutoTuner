...
class TestDecoder(TestCommon):
    def __init__(
        ...
        pg_collection = None
        decoder = TransformerBlock(tf_config, spec = get_gpt_layer_with_transformer_engine_spec(), post_process=False, pg_collection = pg_collection)
        self.op = DecoderForTest(preprocess, decoder, tf_config)
