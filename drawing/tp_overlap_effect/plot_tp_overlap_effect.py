...
def default_output_path() -> Path:
    ...
    return Path("outputs") / "drawing" / "tp_overlap_effect" / timestamp / "tp_overlap_effect.png"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--title", type=str, default="TP Overlap Overhead", help="Figure title.")
